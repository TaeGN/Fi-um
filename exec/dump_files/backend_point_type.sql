...
CREATE TABLE `point_type` (
  `point_type_no` int NOT NULL AUTO_INCREMENT,
  `point_type` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`point_type_no`)
...
INSERT INTO `point_type` VALUES (1,'예금'),(2,'적금'),(3,'경매'),(4,'펀딩'),(5,'후원'),(6,'주식'),(7,'퀴즈'),(8,'캐시'),(9,'기부'),(10,'예금이자'),(11,'적금이자');
